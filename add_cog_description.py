...
with open('D:\my_downloads\Study\laboratory\kor\kogs_letter.txt') as c:
    for line in c:
        letter = line.split('\t')[0]
        descr = line.split('\t')[1]
...
df = pd.read_excel('D:\my_downloads\Study\laboratory\kor\\cog_fisher\cogs_stat_bonf.xlsx', sheet_name='Лист1')
...
with pd.ExcelWriter('D:\my_downloads\Study\laboratory\kor\\cog_fisher\group_cogs_descr.xlsx') as w:
    df.to_excel(w)